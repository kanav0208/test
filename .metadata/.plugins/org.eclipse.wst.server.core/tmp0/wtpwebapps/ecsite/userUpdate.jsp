		...
		<div>
			...
			<s:form action="UserUpdateAction">
				<tr>
					...
					<td><input type="text" name="loginUserId" value="<s:property value="session.loginId"/>"/></td>
				</tr>
				<tr>
					<td>確認用：</td>
					<td><input type="text" name="checkLoginId" value="<s:property value="session.loginId"/>"/></td>
				</tr>
							  <tr>
					<td>
						<br>
